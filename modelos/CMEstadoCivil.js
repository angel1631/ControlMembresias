module.exports = function(sequelize, DataTypes){
	var CMEstadoCivil = sequelize.define('CMEstadoCivil', {
		...
		classMethods:  { associate: function(models){ 
								CMEstadoCivil.belongsTo(models.Usuario, {as: 'Creador', constraints: false})
							}}, 
		seguridad: {
			1: 'CMEstadoCivilIns', 2: 'CMEstadoCivilAct', 3: 'CMEstadoCivilEli', 4: 'CMEstadoCivilBus' 
		}
	});
	return CMEstadoCivil;
}